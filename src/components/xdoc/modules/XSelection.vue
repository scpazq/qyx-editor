...
<template>
    <x-topic>
        ...
        <template>
            <x-topic-option v-model="form.amResTqOptionList"
                            :disabled="disabled"></x-topic-option>
        </template>
        <template #attr>
            <x-topic-attr>
                <x-topic-attr-item label="答案">
                    <div class="answer">
                        <x-answer-option
                            v-model="form.amResTqAnswerList"
                            :disabled="disabled"
                            :is-multiple="multipleAnswer"
                        ></x-answer-option>
                    </div>
                </x-topic-attr-item>
...
import XAnswerOption from '@/components/xdoc/modules/XAnswerOption'
...
export default {
    name: 'XSelection',
    components: {XTopicOption, XTopic, XTopicAttrItem, XTopicAttr, XEditor, XAnswerOption},
    props: {
        value: {
            type: Object,
            default: () => ({})
